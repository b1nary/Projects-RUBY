...
* I will use **Ruby** to solve these. Because i would like to master ruby.
...
* I most likely wont do the half, but will do some as "i am bored right now"-projects

I will link to each project that I complete. Some will be in this same repo, some bigger ones may will have dedicated repos.
...
**[Find PI to the Nth Digit](https://github.com/b1nary/Projects-RUBY/blob/master/Numbers/pi.rb)** – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.
...
**[Reverse a String](https://github.com/b1nary/Projects-RUBY/blob/master/Text/reverse.rb)** – Enter a string and the program will reverse it and print it out.

**[Pig Latin](https://github.com/b1nary/Projects-RUBY/blob/master/Text/pig-latin.rb)** – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**[Count Vowels](https://github.com/b1nary/Projects-RUBY/blob/master/Numbers/vowels.rb)** – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

**[Check if Palindrome](https://github.com/b1nary/Projects-RUBY/blob/master/Numbers/palindrome.rb)** – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
...
*removed classes, sounded like boring homework*
